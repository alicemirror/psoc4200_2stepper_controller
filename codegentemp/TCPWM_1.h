...
/* Signal present */
#define TCPWM_1_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define TCPWM_1_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
#define TCPWM_1_TC_COUNT_SIGNAL_MODE           (0lu)
#define TCPWM_1_TC_START_SIGNAL_MODE           (0lu)
#define TCPWM_1_TC_STOP_SIGNAL_MODE            (0lu)
#define TCPWM_1_TC_CAPTURE_SIGNAL_MODE         (0lu)

/* Signal present */
#define TCPWM_1_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define TCPWM_1_TC_COUNT_SIGNAL_PRESENT        (1lu)
#define TCPWM_1_TC_START_SIGNAL_PRESENT        (1lu)
#define TCPWM_1_TC_STOP_SIGNAL_PRESENT         (1lu)
#define TCPWM_1_TC_CAPTURE_SIGNAL_PRESENT      (1lu)
...
/* Signal modes */
#define TCPWM_1_PWM_RELOAD_SIGNAL_MODE         (3lu)
#define TCPWM_1_PWM_COUNT_SIGNAL_MODE          (3lu)
#define TCPWM_1_PWM_START_SIGNAL_MODE          (3lu)
#define TCPWM_1_PWM_STOP_SIGNAL_MODE           (3lu)
