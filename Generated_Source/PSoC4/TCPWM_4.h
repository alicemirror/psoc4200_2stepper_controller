...
/* TCPWM Configuration */
#define TCPWM_4_CONFIG                         (7lu)

/* Quad Mode */
/* Parameters */
#define TCPWM_4_QUAD_ENCODING_MODES            (0lu)
#define TCPWM_4_QUAD_AUTO_START                (0lu)
...
/* Signal present */
#define TCPWM_4_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define TCPWM_4_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
#define TCPWM_4_TC_COUNT_SIGNAL_MODE           (0lu)
#define TCPWM_4_TC_START_SIGNAL_MODE           (0lu)
#define TCPWM_4_TC_STOP_SIGNAL_MODE            (0lu)
#define TCPWM_4_TC_CAPTURE_SIGNAL_MODE         (0lu)

/* Signal present */
#define TCPWM_4_TC_RELOAD_SIGNAL_PRESENT       (1lu)
#define TCPWM_4_TC_COUNT_SIGNAL_PRESENT        (1lu)
#define TCPWM_4_TC_START_SIGNAL_PRESENT        (1lu)
#define TCPWM_4_TC_STOP_SIGNAL_PRESENT         (1lu)
#define TCPWM_4_TC_CAPTURE_SIGNAL_PRESENT      (1lu)
...
/* Signal modes */
#define TCPWM_4_PWM_RELOAD_SIGNAL_MODE         (3lu)
#define TCPWM_4_PWM_COUNT_SIGNAL_MODE          (3lu)
#define TCPWM_4_PWM_START_SIGNAL_MODE          (3lu)
#define TCPWM_4_PWM_STOP_SIGNAL_MODE           (3lu)
