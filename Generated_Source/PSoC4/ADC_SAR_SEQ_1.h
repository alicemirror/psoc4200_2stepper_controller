...
#define ADC_SAR_SEQ_1_NOMINAL_CLOCK_FREQ             (1714286)
...
#define ADC_SAR_SEQ_1_DEFAULT_POWER \
       ((ADC_SAR_SEQ_1_NOMINAL_CLOCK_FREQ > (ADC_SAR_SEQ_1_MAX_FREQUENCY / 2)) ? ADC_SAR_SEQ_1_NORMAL_PWR : \
       ((ADC_SAR_SEQ_1_NOMINAL_CLOCK_FREQ > (ADC_SAR_SEQ_1_MAX_FREQUENCY / 4)) ? ADC_SAR_SEQ_1_HALF_PWR : \
